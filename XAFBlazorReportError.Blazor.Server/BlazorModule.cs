...
public sealed class XAFBlazorReportErrorBlazorModule : ModuleBase {
    ...
    public XAFBlazorReportErrorBlazorModule() {
    }
    ...
    {
        Application.ConnectionString = "Integrated Security=SSPI;Pooling=false;Data Source=(localdb)\\mssqllocaldb;Initial Catalog=XAFBlazorReportError2";
    }
